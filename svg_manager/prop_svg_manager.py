...
class PropSvgManager:
    ...
    def update_prop_image(self, prop: "Prop") -> None:
        ...
        if prop.prop_type != "Hand":
            colored_svg_data = self.manager.color_manager.apply_color_transformations(svg_data, prop.color)
        else:
    ...
    def _get_prop_image_file(self, prop: "Prop") -> str:
        ...
        if prop.prop_type == "Hand":
            ...
            return f"{PROP_DIR}{prop.prop_type}.png"
        else:
            return f"{PROP_DIR}{prop.prop_type}.svg"
