...
def test_single_beat_cascade():
    ...
    if construct_tab.option_picker_manager and construct_tab.option_picker_manager.option_picker:
    ...
    if construct_tab.layout_manager:
        ...
        original_transition_to_option = construct_tab.layout_manager.transition_to_option_picker
        ...
        construct_tab.layout_manager.transition_to_option_picker = tracked_transition_to_option
        
        original_transition_to_start = construct_tab.layout_manager.transition_to_start_position_picker
        def tracked_transition_to_start(*args, **kwargs):
            monitor.track_picker_transition()
            return original_transition_to_start(*args, **kwargs)
        construct_tab.layout_manager.transition_to_start_position_picker = tracked_transition_to_start
    ...
    print("   • Each single beat addition should trigger at most 1 option_picker_refresh")
