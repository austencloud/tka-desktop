...
Adapts the existing legacy settings structure to work with modern's interface-based approach.
"""
...
class LegacySettingsAdapter(ISettingsService):
    """Adapts legacy settings to the modern ISettingsService interface"""
...
class LegacyUserProfileService(IUserProfileService):
    """Adapts legacy user profile settings to modern interface"""
...
class LegacyPropTypeService(IPropTypeService):
    """Adapts legacy prop type settings to modern interface"""
...
class LegacyVisibilityService(IVisibilityService):
    """Adapts legacy visibility settings to modern interface"""
...
class LegacyBeatLayoutService(IBeatLayoutService):
    """Adapts legacy beat layout settings to modern interface"""
...
class LegacyImageExportService(IImageExportService):
    """Adapts legacy image export settings to modern interface"""
