...
def validate_inputs(**validators: Dict[str, Callable[[Any], bool]]) -> Callable:
    """
    ...
    def decorator(func: Callable) -> Callable:
        ...
        def wrapper(*args, **kwargs):
            ...
            try:
                ...
                logger.log(logging.ERROR, f"Failed operation: {op_name}", extra=log_data)
                raise
    ...
    def decorator(func: Callable) -> Callable:
        ...
        def wrapper(*args, **kwargs):
            ...
            try:
                ...
                op_name = f"{args[0].__class__.__name__}.{func.__name__}" if args else func.__name__
