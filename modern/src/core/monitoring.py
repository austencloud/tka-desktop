...
def monitor_performance(operation_name: Optional[str] = None, context: Optional[Dict[str, Any]] = None):
    """
    ...
    def decorator(func: Callable) -> Callable:
        ...
        def wrapper(*args, **kwargs):
            ...
            try:
                ...
                memory_mb = max(start_memory, end_memory)  # Peak memory during operation
