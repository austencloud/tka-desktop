...
modern_dir = os.path.dirname(os.path.dirname(__file__))
...
from src.presentation.components.workbench.workbench import ModernSequenceWorkbench
...
def test_start_position_clear():
    ...
    print(
        f"- Start position view position data: {start_pos_view.get_position_data() is not None}"
    )
