...
def test_complete_workflow():
    ...
    # Simulate Legacy-style sequence building workflow
...
def test_signal_flow_simulation():
    ...
    assert (
        construct_tab.option_picker.refresh_count == 3
    )  # Should refresh for sequences with beats
