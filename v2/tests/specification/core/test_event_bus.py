...
class TestEventPriority:
    ...
    def test_priority_ordering(self, event_bus, sample_sequence_event):
        ...
        event_bus.subscribe("sequence.created", normal_priority_handler, EventPriority.NORMAL)
        event_bus.subscribe("sequence.created", high_priority_handler, EventPriority.HIGH)
