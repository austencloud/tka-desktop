#!/usr/bin/env python3
"""
Integration tests for enhanced DI container with existing V2 services.

Tests that the enhanced DI container works correctly with real V2 services
...
class TestEnhancedDIWithExistingServices:
    """Test enhanced DI container with existing V2 services."""
    ...
    def test_complex_service_chain_with_real_services(self):
        """Test complex dependency chains with real V2 services."""
        try:
            from application.services.simple_layout_service import SimpleLayoutService
            from application.services.ui.ui_state_management_service import (
                UIStateManagementService,
