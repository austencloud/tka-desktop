...
from src.application.services.graph_editor_hotkey_service import GraphEditorHotkeyService
from src.presentation.components.workbench.graph_editor.modern_graph_editor import ModernGraphEditor
