...
Automated test lifecycle management for TKA V2.
...
class TestLifecycleManager:
    ...
    def find_problematic_tests(self) -> Dict[str, List[TestMetadata]]:
        ...
        for test in all_tests:
            ...
            if (test.lifecycle == "SCAFFOLDING" and test.created and 
                (self.today - test.created).days > 30):
    ...
    def _extract_metadata(self, file_path: Path) -> Optional[TestMetadata]:
        ...
        try:
            ...
            # Parse dates
            delete_after = self._parse_date(delete_after_str) if delete_after_str else None
    ...
    def generate_cleanup_report(self) -> str:
        ...
        if expired_tests:
            ...
            for test in expired_tests:
                ...
                report += f"- **Path**: `{test.file_path.relative_to(self.tests_root)}`\n"
...
def main():
    ...
    parser.add_argument("--problems", action="store_true", help="List problematic tests")
