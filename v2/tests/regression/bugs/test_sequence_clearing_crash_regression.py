...
class TestSequenceClearingCrashRegression:
    ...
    def test_multiple_sequence_operations_no_crash(self):
        ...
        beat1 = self.dataset_service.get_start_position_pictograph("alpha1_alpha1", "diamond")
        beat2 = self.dataset_service.get_start_position_pictograph("beta5_beta5", "diamond")
    ...
    def test_performance_regression_sequence_operations(self):
        ...
        if beat:
            ...
            assert duration_ms < 1000, f"Sequence operations took {duration_ms}ms (performance regression)"
