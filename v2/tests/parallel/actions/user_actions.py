...
PURPOSE: Standardize user actions for V1/V2 comparison testing
"""
...
class ExpectedOutcome:
    ...
    # Validation rules
    tolerance_rules: Dict[str, float] = field(default_factory=lambda: {
        "turns": 0.001,
        "position": 1.0,
        "rotation": 0.1
    })
...
class UserAction:
    ...
    on both V1 and V2 for comparison testing.
    """
...
class ActionSequence:
    ...
    def estimate_total_duration(self) -> int:
        ...
        return sum(action.expected_outcome.max_execution_time_ms for action in self.actions)
