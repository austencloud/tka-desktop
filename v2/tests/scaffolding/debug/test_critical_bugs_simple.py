#!/usr/bin/env python3
"""
Simple Critical Bug Tests for TKA V2
====================================

Direct tests for critical bugs without complex UI setup:
...
def test_clear_sequence_crash():
    ...
    try:
        ...
        if real_beat:
            ...
            print(f"   ✅ Sequence with beats created: {sequence_with_beats.length} beats")
...
def test_option_selection_workflow():
    ...
    try:
        ...
        start_position = dataset_service.get_start_position_pictograph("alpha1_alpha1", "diamond")
        ...
        if start_position:
            ...
            try:
                ...
                beta_beat = dataset_service.get_start_position_pictograph("beta5_beta5", "diamond")
                if beta_beat:
...
def test_construct_tab_integration():
    ...
    try:
        ...
        try:
            new_beat = dataset_service.get_start_position_pictograph("beta5_beta5", "diamond")
            if new_beat:
