...
class ILayoutManagementService(ABC):
    ...
    @abstractmethod
    def calculate_beat_frame_layout(self, sequence: SequenceData, container_size: Tuple[int, int]) -> Dict[str, Any]:
...
class LayoutManagementService(ILayoutManagementService):
    """
    ...
    def calculate_context_aware_scaling(self, context: str, base_size: Tuple[int, int], container_size: Tuple[int, int]) -> float:
        """Calculate scaling based on context."""
        context_configs = {
            "sequence_editor": {"min_scale": 0.5, "max_scale": 2.0, "preferred_scale": 1.0},
            "dictionary_browser": {"min_scale": 0.3, "max_scale": 1.5, "preferred_scale": 0.8},
            "beat_frame": {"min_scale": 0.4, "max_scale": 1.8, "preferred_scale": 1.0},
            "pictograph_viewer": {"min_scale": 0.2, "max_scale": 3.0, "preferred_scale": 1.2},
        }
        
        config = context_configs.get(context, {"min_scale": 0.5, "max_scale": 2.0, "preferred_scale": 1.0})
    ...
    def _calculate_horizontal_beat_layout(
        self, beat_count: int, container_size: Tuple[int, int], 
        base_size: Tuple[int, int], padding: int, spacing: int
    ) -> Dict[str, Any]:
    ...
    def _calculate_flow_layout(self, components: Dict[str, Any], container_size: Tuple[int, int]) -> Dict[str, Tuple[int, int]]:
    ...
    def _calculate_grid_layout(self, components: Dict[str, Any], container_size: Tuple[int, int]) -> Dict[str, Tuple[int, int]]:
