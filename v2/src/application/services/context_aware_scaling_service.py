...
class ContextAwareScalingService:
    ...
    def _calculate_option_view_scale(
        ...
        # V1 logic: size = max(mw_width//16, option_picker.width//8)
        ...
        # Apply V1's border width calculation: border_width = max(1, int(size * 0.015))
        border_width = max(1, int(target_size * 0.015))
        # V1 adjustment: size -= 2 * border_width + spacing
    ...
    def _calculate_start_pos_picker_scale(
        ...
        # V1 logic: size = size_provider.width//10
        ...
        # Apply V1's border width calculation: border_width = max(1, int(size * 0.015))
        border_width = max(1, int(target_size * 0.015))
        # V1 adjustment: size -= 2 * border_width
    ...
    def _calculate_advanced_start_pos_scale(
        ...
        # V1 logic: size = size_provider.width//12
        size_provider_width = context_params.get(
            "size_provider_width", container_size.width()
        )
    ...
    def _calculate_codex_view_scale(
        ...
        # V1 logic: size = codex.main_widget.width//16
    ...
    def _calculate_beat_view_scale(
        ...
        # V1 logic: view_scale = min(view_size/beat_scene_size)
        ...
        # Apply V1-style enhancement factor
    ...
    def _calculate_graph_editor_scale(
        ...
        # V1 logic: scale_factor = min(view_size/scene_size)
        view_width = container_size.width()
        view_height = container_size.height()
    ...
    def _calculate_default_scale(
        ...
        # Enhanced default scaling to match V1's general behavior
        ...
        # Apply general enhancement factor to match V1 visual prominence
        default_enhancement = 1.08  # 8% enhancement to match V1 behavior
