...
Replicates V1's sophisticated beat sizing logic with precise
...
class EnhancedBeatResizerService:
    """
    Enhanced beat frame resizer with V1's exact sizing algorithms.
    ...
    def resize_beat_frame(
        ...
        """
        Complete beat frame resize using V1's exact algorithm.
    ...
    def calculate_dimensions(self, beat_frame: "SequenceBeatFrame") -> Tuple[int, int]:
        """
        Calculate available container dimensions using V1's exact logic.
        ...
        # Calculate available width with V1's formula
    ...
    def calculate_beat_size(self, width: int, height: int, num_columns: int) -> int:
        ...
        if num_columns == 0:
            ...
            # V1's exact calculation - THIS IS THE KEY LOGIC!
    ...
    def configure_scroll_behavior(self, beat_frame: "SequenceBeatFrame", num_rows: int):
        """
        Configure scroll bar behavior using V1's exact logic.
