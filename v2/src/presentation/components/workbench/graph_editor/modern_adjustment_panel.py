...
class ModernAdjustmentPanel(QWidget):
    """V1-exact adjustment panel implementation for graph editor."""
    ...
    def __init__(self, parent, side: str = "right"):
        ...
        self._side = side  # "left" or "right" to match V1's left_stack/right_stack
    ...
    def _setup_ui(self):
        """Setup V1-exact UI structure: Hand Indicator, Turn Display, +/- Buttons, Motion Type."""
    ...
    def _adjust_turn(self, amount: float):
        """Adjust turn value by the specified amount (V1-exact behavior)."""
        current_turn = self._get_current_turn_value(self._arrow_color)
    ...
    def _update_turn_display_value(self, turn_value: float):
        ...
        # Format like V1: show "fl" for float, otherwise show number
