...
class OptionPickerManager(QObject):
    ...
    def populate_from_start_position(self, position_key: str, start_position_data: BeatData):
        ...
        try:
            ...
            extracted_end_pos = self.data_conversion_service.extract_end_position_from_position_key(
                position_key
            )
