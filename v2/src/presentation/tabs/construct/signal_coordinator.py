...
class SignalCoordinator(QObject):
    ...
    def _setup_signal_connections(self):
        ...
        self.sequence_manager.sequence_modified.connect(
            self._handle_sequence_modified
        )
        self.sequence_manager.sequence_cleared.connect(
    ...
    def _handle_sequence_modified(self, sequence: SequenceData):
        ...
        print(f"✅ Signal coordinator: Sequence modified with {sequence.length if sequence else 0} beats")
    ...
    def connect_external_workbench_signals(self, workbench):
        ...
        if workbench:
            ...
            workbench.operation_completed.connect(
                self._handle_operation_completed
            )
