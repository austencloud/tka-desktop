...
class PositionMappingService:
    ...
    def _initialize_position_maps(self) -> Dict[str, Dict[str, str]]:
        return {
            "start_end_loc_map": {
    ...
    def get_position_mapping(self, mapping_type: str) -> Dict[str, str]:
...
class PropClassMappingService:
    ...
    def _initialize_prop_mappings(self) -> Dict[str, str]:
        return {
            prop: f"{prop}_class" for prop in PROPS.values()
        }
