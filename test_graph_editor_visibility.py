    ...
    try:
        ...
        if hasattr(workbench, '_graph_section') and workbench._graph_section:
            ...
            if hasattr(graph_section, '_graph_editor') and graph_section._graph_editor:
                ...
                print(f"      Graph editor size: {graph_editor.size().width()}x{graph_editor.size().height()}")
                ...
                if hasattr(graph_editor, '_toggle_tab') and graph_editor._toggle_tab:
                    ...
                    print(f"      Toggle tab position: {toggle_tab.pos().x()}, {toggle_tab.pos().y()}")
                    print(f"      Toggle tab size: {toggle_tab.size().width()}x{toggle_tab.size().height()}")
