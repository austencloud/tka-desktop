...
from main_window.main_widget.construct_tab.add_to_sequence_manager import AddToSequenceManager
...
class OptionPicker(QWidget):
    ...
    def __init__(
        ...
        self.reversal_filter = OptionPickerReversalFilter(mw_size_provider, self.updater.update_options)
