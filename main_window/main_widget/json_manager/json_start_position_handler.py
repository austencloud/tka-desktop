...
class JsonStartPositionHandler:
    ...
    def set_start_position_data(self, start_pos_pictograph: PictographScene) -> None:
    ...
    def get_sequence_start_position(self, start_pos_pictograph: PictographScene) -> str:
