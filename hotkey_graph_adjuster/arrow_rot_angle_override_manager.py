...
class ArrowRotAngleOverrideManager:
    ...
    def _apply_override_if_needed(
        ...
        turns_tuple = TurnsTupleGenerator().generate_turns_tuple(
            self.hotkey_graph_adjuster.ge_view.get_current_pictograph()
        )
    ...
    def _apply_rotation_override(
        ...
        letter_data = (
            data.get(self.view.get_current_pictograph().state.grid_mode, {})
            .get(ori_key, {})
    ...
    def _update_mirrored_entry_with_rotation_override(self, updated_turn_data: dict):
        mirrored_entry_manager = (
            self.hotkey_graph_adjuster.ge_view.get_current_pictograph().managers.arrow_placement_manager.data_updater.mirrored_entry_manager
        )
