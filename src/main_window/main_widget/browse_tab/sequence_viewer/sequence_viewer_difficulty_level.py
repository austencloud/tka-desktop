...
class SequenceViewerDifficultyLabel(QToolButton):
    def __init__(self, sequence_viewer: "SequenceViewer"):
        ...
        self.main_widget = sequence_viewer.main_widget
    ...
    def update_difficulty_label(self):
        ...
        current_thumbnail = self.sequence_viewer.state.get_current_thumbnail()
    ...
    def update_icon(self):
        ...
        size = max(24, self.sequence_viewer.width() // 12)  # Ensure min size
