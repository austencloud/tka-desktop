...
class PictographExporter:
    ...
    def _filter_pictographs(self, pictographs: List[Pictograph]) -> List[Pictograph]:
        """
        Filter out blank pictographs and duplicates.
    ...
    def _export_pictographs(self, pictographs: List[Pictograph], directory: str) -> int:
        """
        ...
        for i, pictograph in enumerate(pictographs):
            try:
                ...
                # Create filename
                filename = f"pictograph_{letter}_{start_pos}_{end_pos}_{timestamp}_{i+1}.png"
