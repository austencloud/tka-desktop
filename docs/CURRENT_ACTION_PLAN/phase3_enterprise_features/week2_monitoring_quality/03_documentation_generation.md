...
"""
Automatic documentation generation for TKA modern.
...
class DocumentationGenerator:
    ...
    def _generate_api_docs(self) -> None:
        ...
        content = [
            ...
            "",
            "This document describes the REST API for TKA Desktop modern.",
            "",
            "## Base URL",
            "```",
    ...
    def _generate_service_docs(self) -> None:
        ...
        content = [
            ...
            "",
            "This document provides detailed information about all services in TKA modern.",
            ""
        ]
    ...
    def _generate_user_guide(self) -> None:
        ...
        content = [
            ...
            "3. Run the application: `python modern/main.py`",
            "",
            "### Basic Usage",
            "",
